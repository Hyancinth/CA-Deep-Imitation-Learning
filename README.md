...
- Continue testing neural network
    ...
    - Test changing the layer architecture to be: 128 -> 64 -> 32 -> 2
...
- Basic Ann 2
    ...
    - At 500 epochs, trained on data_317_01_100, 
- data_317_01_100.h5 and hidden_test_data(_1).h5 are files that do not have ee_dx_target/ee_dy_target
    ...
    - At 500 epochs, the model also violates the ground constraint
